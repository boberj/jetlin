...
**Status:** phases 1–6 implemented, `:samples:demo` included. `./gradlew build` is green (353 tests in the
main build plus 10 in the migration tooling's included build), and the browser suite is 35/36 — the same
35/36 it was before this work, the one failure being pre-existing and unrelated (see §13).
